...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		    if PirateRaid or FarmBone or NearFarm or Mirage or FarmKata or FarmLevel or TeleTween or BringFruit or UpRaceV2 or NoClip then
...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		  	if PirateRaid or FarmBone or NearFarm or Mirage or FarmKata or FarmLevel or TeleTween or BringFruit or UpRaceV2 then
...
Tele:Toggle("Đi Tới Đảo",false,function(value)
    ...
    repeat wait()
        ...
        elseif SelectIsland == "Đảo Trên Không 1" then
            TP(CFrame.new(-4869.1025390625, 733.46051025391, -2667.0180664063))
        elseif SelectIsland == "Đảo Trên Không 2" then  
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
        elseif SelectIsland == "Đảo Trên Không 3" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
        ...
        elseif SelectIsland == "Cảng 1" then
